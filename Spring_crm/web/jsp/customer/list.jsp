									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<%--
													<s:iterator></<s:iterator>标签会自动从Context(ActionContext)中取出list集合进行遍历,
													每次遍历,它会将当前list集合中的元素压到值栈的栈顶(Root部分)
												--%>
												<s:iterator value="#list">
													<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
														<TD>
															<s:property value="cust_name"/>
															<%--<s:property/>Struts2中专门用于书写OGNL表达式的标签(它是专门用于替换EL表达式的标签)--%>
														</TD>
														<TD>
												...
												<%--
													<s:iterator></<s:iterator>标签会自动从Context(ActionContext)中取出list集合进行遍历,
													每次遍历,它会将当前list集合中的元素放到Context(ActionContext)中,其中var的值就是往
													ActionContext中放的当前元素的键的名称
												--%>
												...
												&lt;%&ndash;
													...
													${requestScope.list }相当于调用request.getAttribute("list");
												&ndash;%&gt;
												<TR
